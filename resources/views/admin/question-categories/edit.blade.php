        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between gap-3 flex-wrap">
                <div>
                    ...
                    <p class="text-muted mb-0 fs-13">Perbarui section, nama, dan status kategori soal.</p>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <span class="badge bg-primary-subtle text-primary rounded-pill">{{ $questionCategory->section }}</span>
                    <span class="badge bg-info-subtle text-info rounded-pill">{{ $questionCategory->questions_count ?? 0 }} soal</span>
                </div>
