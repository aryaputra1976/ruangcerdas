...
<body class="bg-slate-50 text-slate-900 antialiased">
    ...
    @if ($globalWaUrl)
        <a href="{{ $globalWaUrl }}"
           ...
           class="fixed bottom-20 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-green-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-green-700/25 transition hover:bg-green-700 md:bottom-6 md:right-6"
