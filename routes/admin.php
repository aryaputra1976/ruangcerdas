...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/ad-creatives', [AdCreativeController::class, 'index'])->name('ad-creatives.index');
        Route::get('/ad-creatives/create', [AdCreativeController::class, 'create'])->name('ad-creatives.create');
        Route::post('/ad-creatives', [AdCreativeController::class, 'store'])->name('ad-creatives.store');
        Route::get('/ad-creatives/{adCreative}/edit', [AdCreativeController::class, 'edit'])->name('ad-creatives.edit');
        Route::match(['put', 'patch'], '/ad-creatives/{adCreative}', [AdCreativeController::class, 'update'])->name('ad-creatives.update');
        Route::get('/ad-creatives/{adCreative}', [AdCreativeController::class, 'show'])->name('ad-creatives.show');
        Route::post('/ad-creatives/{adCreative}/duplicate', [AdCreativeController::class, 'duplicate'])->name('ad-creatives.duplicate');
        Route::get('/ad-creatives/{adCreative}/download', [AdCreativeController::class, 'download'])->name('ad-creatives.download');
        Route::delete('/ad-creatives/{adCreative}', [AdCreativeController::class, 'destroy'])->name('ad-creatives.destroy');
